...
def style_transfer_separate(style, content, style_mask, device="cpu", interpolation_weights=None,
    ...
    output_fg = style_transfer(vgg, decoder, content_fg, style_fg, args.alpha,
    ...
    output_bg = style_transfer(vgg, decoder, content_bg, style_bg, args.alpha,
                               interpolation_weights=interpolation_weights)
    # Add 0.5 after unnormalizing to [0, 255] to round to nearest integer
...
parser.add_argument('--decoder', type=str, default='assets/models/decoder_epoch_5-wound_healing.pt')
